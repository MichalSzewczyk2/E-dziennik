...
--
-- Ograniczenia -- phpMyAdmin SQL Dump
                -- version 5.2.0
                -- https://www.phpmyadmin.net/
                --
                -- Host: 127.0.0.1
                -- Czas generowania: 09 Sty 2023, 11:16
                -- Wersja serwera: 10.4.27-MariaDB
                -- Wersja PHP: 8.2.0
                ...
                (2, 1, 1, 2, 4, 'Test', NULL, '2023-01-03'),
                (4, 2, 1, 2, 5, 'Sprawdzian', NULL, '2023-01-02'),
                (7, 1, 1, 2, 4, 'Sprawdzian z Mickiewicza', NULL, '2023-01-05'),
                (8, 1, 1, 2, 5, 'Sprawdzian z Wesela', NULL, '2022-12-29'),
                (9, 2, 1, 3, 4, '', NULL, '2023-01-03'),
                (10, 2, 1, 9, 2, '', NULL, '2023-01-03'),
                (11, 2, 2, 9, 4, 'Tabliczka mnożenia', NULL, '2023-01-04');
                ...
                (1, 1, 1, 5, 1, 'poniedzialek', '08:00:00', '08:45:00'),
                (2, 1, 2, 5, 4, 'wtorek', '08:00:00', '08:45:00');
                ...
                INSERT INTO `messages` (`message_id`, `chat_id`, `user_id`, `date`, `message`) VALUES
                (1, 1, 2, '2023-01-03', 'Cześć'),
                (2, 4, 5, '2023-01-07', 'Witam'),
                (3, 7, 5, '2023-01-07', 'Witam '),
                (4, 8, 2, '2023-01-09', 'Witam'),
                (5, 8, 5, '2023-01-09', 'Dzien dobry'),
                (6, 8, 2, '2023-01-09', 'XD');
                ...
                (1, 2, 5, '2023-01-02', 'Uwaga', 'Treść uwagi');
                ...
                (3, 'pnowak', '12345', 'Piotr', 'Nowak', 'PNowak@mail.com', 333222333, 'uczen'),
                (4, 'parent', 'parent', 'parent', 'parent', 'parent@mail.com', 444333222, 'rodzic'),
                (5, 'teacher', 'teacher', 'teacher', 'teacher', 'teacher@mail.com', 90878656, 'nauczyciel'),
                (6, 'pawelJ', '12345', 'Paweł', 'Jumper', 'PJumper@mail.com', 232333222, 'nauczyciel'),
                (7, 'Psokol', '12345', 'Paweł', 'Sokół', 'sokol@mail.com', 232425621, 'uczen'),
                (8, 'KonradK', '12345', 'Konrad', 'Kierepka', 'kierepka@mail.com', 222777666, 'uczen'),
                (9, 'MSzewczyk', '12345', 'Michał', 'Szewczyk', 'szewczyk@mail.com', 666555666, 'uczen');
                ...
                --
                ALTER TABLE `grade`
                  MODIFY `grade_id` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

                --
                -- AUTO_INCREMENT dla tabeli `notes`
                --
                ALTER TABLE `notes`
                  MODIFY `note_id` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
